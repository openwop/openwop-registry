...
// P3-0). The canonical ref is the published corpus tag recorded in ./CORPUS_TAG
// (`openwop-conformance/vX.Y.Z`), never `main`: the corpus is about to grow
// `schemas/v2/`, and a guard that follows `main` would compare these v1 copies
// against v2 canonicals. The 2026-09-03 inventory also found 7 of these 13
// schemas drifted from the corpus (the node-pack schema lacked the RFC 0138
// vendor hatch, so this registry rejected a field the protocol requires packs
// to carry) — the same PR re-vendors all 13 from the tag. Bump CORPUS_TAG
